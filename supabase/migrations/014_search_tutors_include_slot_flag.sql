drop function if exists public.search_tutors_within_radius(double precision, double precision, numeric);

create function public.search_tutors_within_radius(
